...
?>
  ...
  <img data-toggle="modal"  style="width:100%;height:400px; cursor:pointer; border-radius:100%;" class="mx-auto shadow w-100" src="<?php
...
if(count($myArrs)>4){
  $length=count($myArrs);
 $myArrs=(array_slice($myArrs,0, 4 ,false));
